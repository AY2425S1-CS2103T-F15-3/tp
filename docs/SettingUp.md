...
2. [Before writing code](#before-writing-code)
   - [Configure the coding style](#configure-the-coding-style)
   - [Set up CI](#set-up-ci)
   - [Learn the design](#learn-the-design)
   - [Do the tutorials](#do-the-tutorials)
...
1. **Learn the design**
   ...
   When you are ready to start coding, we recommend that you get some sense of the overall design by reading about [PROperty’s architecture](DeveloperGuide.md#architecture).
